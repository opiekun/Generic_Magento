...
class ImportReviewsUpdate implements DataPatchInterface
{
    /**
     * @var Csv
     */
    ...
    /**
     * @return ImportReviewsUpdate
     * @throws NoSuchEntityException
     */
    public function apply(): ImportReviewsUpdate
    {
    ...
    private function getReviewData(): array
    {
        ...
        $filePath = $this->dirReader->getModuleDir('Setup', 'Ecommerce121_ReviewData')
            . '/Patch/Fixtures/customer_reviews.csv';
