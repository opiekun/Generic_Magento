...
function UGHtml5MediaAPI(){
	...
	this.loadAPI = function(){
		...
		g_ugFunctions.loadJs("cdnjs.cloudflare.com/ajax/libs/mediaelement/4.2.9/mediaelement.min.js", true);
		
		//g_ugFunctions.loadJs("cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18.1/mediaelement.min.js", true);
		g_ugFunctions.loadCss("cdnjs.cloudflare.com/ajax/libs/mediaelement/4.2.9/mediaelementplayer.min.css", true);
