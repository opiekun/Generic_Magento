...
class GetImageswoFilterBlock extends \FME\Photogallery\Controller\Index
{
    ...
    public function execute()
    {
        ...
        $collection=array();
        $galler="gallery_";
        $collection=$block->getPhotoGalleryImagesbyIdForAjex($id);
        $collection->getSelect()->limit($_itemsOnPage, $childs);
        $html1=[];
        $html1= "";
        foreach ($collection as $_gimage) {
            $html1 .= $block->createtiles($_gimage);
        }
