...
class MassDeleteTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
        ...
        $this->massDeleteController = $this->objectManager->getObject(
        	\Magezon\CustomerAttachments\Controller\Adminhtml\Attachment\MassDelete::class,
        	[
	...
	public function testMassDeleteAction()
	{
		...
		$this->attachmentCollectionMock->expects($this->once())
			->method('getSize')
			->willReturn($deletedAttachmentCount);
		$this->attachmentCollectionMock->expects($this->once())
			->method('getIterator')
		...
		$this->messageManagerMock->expects($this->once())
			->method('addSuccess')
			->with(__('A total of %1 record(s) have been deleted.', $deletedAttachmentCount));
	...
	{
		$attachmentMock = $this->createPartialMock(\Magezon\CustomerAttachments\Model\ResourceModel\Attachment\CollectionFactory::class, ['delete']);
		$attachmentMock->expects($this->once())->method('delete')->willReturn(true);
