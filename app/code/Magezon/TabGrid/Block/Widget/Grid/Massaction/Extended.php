...
class Extended extends \Magezon\TabGrid\Block\Widget
{
    /**
     * Massaction items
     *
     ...
     * @var string
     */
    protected $_template = 'Magezon_TabGrid::widget/grid/massaction_extended.phtml';

    /**
     * Backend data
     *
     * @var \Magezon\TabGrid\Helper\Data
     */
     ...
     * @param \Magezon\TabGrid\Helper\Data $backendData
     * @param array $data
     */
    public function __construct(
        \Magezon\TabGrid\Block\Template\Context $context,
        \Magento\Framework\Json\EncoderInterface $jsonEncoder,
        \Magezon\TabGrid\Helper\Data $backendData,
        array $data = []
    ) {
    ...
    public function addItem($itemId, array $item)
    {
        $this->_items[$itemId] = $this->getLayout()->createBlock(
            'Magezon\TabGrid\Block\Widget\Grid\Massaction\Item'
        )->setData(
            $item
        )->setMassaction(
            $this
