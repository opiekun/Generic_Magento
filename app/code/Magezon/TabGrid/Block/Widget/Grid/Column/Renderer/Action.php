...
class Action extends \Magezon\TabGrid\Block\Widget\Grid\Column\Renderer\Text
{
    /**
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $out = '<select class="mgz__control-select" onchange="varienGridAction.execute(this);">' .
            '<option value=""></option>';
        $i = 0;
        foreach ($actions as $action) {
            $i++;
