...
class Date extends \Magezon\TabGrid\Block\Widget\Grid\Column\Filter\AbstractFilter
{
    /**
    ...
    public function getHtml()
    {
        ...
        $html = '<div class="range" id="' .
            ...
            $this->getEscapedValue(
                'from'
            ) . '" class="mgz__control-text input-text no-changes" placeholder="' . __(
                'From'
            ) . '" ' . $this->getUiId(
                'filter',
                $this->_getHtmlName(),
        ...
        $html .= '<div class="range-line date">' .
            ...
            $this->getEscapedValue(
                'to'
            ) . '" class="input-text mgz__control-text no-changes" placeholder="' . __(
                'To'
            ) . '" ' . $this->getUiId(
                'filter',
                $this->_getHtmlName(),
