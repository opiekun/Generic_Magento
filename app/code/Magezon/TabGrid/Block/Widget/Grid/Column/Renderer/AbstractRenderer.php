...
abstract class AbstractRenderer extends \Magento\Framework\View\Element\AbstractBlock implements RendererInterface
{
    /**
     * @var int
     */
    ...
    public function render(DataObject $row)
    {
        if ($this->getColumn()->getEditable()) {
            $result = '<div class="mgz__grid-control">';
            $result .= $this->getColumn()->getEditOnly() ? ''
                : '<span class="mgz__grid-control-value">' . $this->_getValue($row) . '</span>';
