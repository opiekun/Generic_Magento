...
class Extended extends \Magezon\TabGrid\Block\Widget\Grid implements \Magezon\TabGrid\Block\Widget\Grid\ExportInterface
{
    /**
     * Columns array
     *
     ...
     *      'sortable'  => bool,
     *      'index'     => string,
     *      //'renderer'  => \Magezon\TabGrid\Block\Widget\Grid\Column\Renderer\Interface,
     *      'format'    => string
     ...
     * @var string
     */
    protected $_massactionBlockName = 'Magezon\TabGrid\Block\Widget\Grid\Massaction\Extended';
     ...
     * @var string
     */
    protected $_template = 'Magezon_TabGrid::widget/grid/extended.phtml';
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            'export_button',
            $this->getLayout()->createBlock('Magezon\TabGrid\Block\Widget\Button')->setData(
                [
                    'label' => __('Export'),
    ...
    public function getColumnSet()
    {
        if (!$this->getChildBlock('grid.columnSet')) {
            $this->setChild(
                'grid.columnSet',
                $this->getLayout()->createBlock('Magezon\TabGrid\Block\Widget\Grid\ColumnSet')
            );
        }
    ...
    public function addColumn($columnId, $column)
    {
        if (is_array($column)) {
            $this->getColumnSet()->setChild(
                $columnId,
                $this->getLayout()
                    ->createBlock('Magezon\TabGrid\Block\Widget\Grid\Column\Extended')
                    ->setData($column)
                    ->setId($columnId)
                    ->setGrid($this)
            );
    ...
    protected function _prepareMassactionColumn()
    {
        ...
        $massactionColumn = $this->getLayout()
            ->createBlock('Magezon\TabGrid\Block\Widget\Grid\Column')
            ->setData(
                [
