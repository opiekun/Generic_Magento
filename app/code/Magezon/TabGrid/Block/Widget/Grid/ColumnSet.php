...
{
    /**
     * @var \Magezon\TabGrid\Model\Widget\Grid\Row\UrlGenerator
     */
     ...
     * @var string
     */
    protected $_template = 'Magezon_TabGrid::widget/grid/column_set.phtml';

    /**
     * @var \Magezon\TabGrid\Model\Widget\Grid\SubTotals
     */
    protected $_subTotals = null;

    /**
     * @var \Magezon\TabGrid\Model\Widget\Grid\Totals
     */
    protected $_totals = null;

    /**
     * @param \Magento\Framework\View\Element\Template\Context $context
     * @param \Magezon\TabGrid\Model\Widget\Grid\Row\UrlGeneratorFactory $generatorFactory
     * @param \Magezon\TabGrid\Model\Widget\Grid\SubTotals $subtotals
     * @param \Magezon\TabGrid\Model\Widget\Grid\Totals $totals
     * @param array $data
     * @SuppressWarnings(PHPMD.NPathComplexity)
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Magezon\TabGrid\Model\Widget\Grid\Row\UrlGeneratorFactory $generatorFactory,
        \Magezon\TabGrid\Model\Widget\Grid\SubTotals $subtotals,
        \Magezon\TabGrid\Model\Widget\Grid\Totals $totals,
        array $data = []
    ) {
        $generatorClassName = 'Magezon\TabGrid\Model\Widget\Grid\Row\UrlGenerator';
