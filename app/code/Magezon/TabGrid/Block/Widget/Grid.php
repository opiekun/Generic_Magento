...
class Grid extends \Magezon\TabGrid\Block\Widget
{
    /**
     ...
     * @var string
     */
    protected $_template = 'Magezon_TabGrid::widget/grid.phtml';
     ...
     *
     * @return \Magezon\TabGrid\Block\Widget\Grid\ColumnSet
     */
    ...
    protected function _prepareGrid()
    {
        $this->_eventManager->dispatch(
            'tabgrid_block_widget_grid_prepare_grid_before',
    ...
    public function getParam($paramName, $default = null)
    {
        ...
        if ($this->getRequest()->has($paramName)) {
            ...
            if ($this->_saveParametersInSession) {
                $this->_customerSession->setData($sessionParamName, $param);
            }
            return $param;
        } elseif ($this->_saveParametersInSession && ($param = $this->_customerSession->getData($sessionParamName))) {
            return $param;
        }
